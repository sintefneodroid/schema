...
public final class FReaction extends Table {
  ...
  public FMotion motionsByKey(String key) { int o = __offset(8); return o != 0 ? FMotion.__lookup_by_key(__vector(o), key, bb) : null; }
  ...
  public FDisplayable displayablesByKey(String key) { int o = __offset(10); return o != 0 ? FDisplayable.__lookup_by_key(__vector(o), key, bb) : null; }
  ...
  public FConfiguration configurationsByKey(String key) { int o = __offset(14); return o != 0 ? FConfiguration.__lookup_by_key(__vector(o), key, bb) : null; }
