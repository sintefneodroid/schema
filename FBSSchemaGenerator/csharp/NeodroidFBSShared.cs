...
public struct FUnobservables : IFlatbufferObject
{
  ...
  public FQuaternionTransform? Poses(int j) { int o = __p.__offset(4); return o != 0 ? (FQuaternionTransform?)(new FQuaternionTransform()).__assign(__p.__vector(o) + j * 56, __p.bb) : null; }
  public int PosesLength { get { int o = __p.__offset(4); return o != 0 ? __p.__vector_len(o) : 0; } }
  public FBody? Bodies(int j) { int o = __p.__offset(6); return o != 0 ? (FBody?)(new FBody()).__assign(__p.__vector(o) + j * 48, __p.bb) : null; }
...
public struct FVector3 : IFlatbufferObject
{
  ...
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public void __init(int _i, ByteBuffer _bb) { __p.bb_pos = _i; __p.bb = _bb; }
  public FVector3 __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
...
public struct FQuaternionTransform : IFlatbufferObject
{
  ...
  public FVector3 Position { get { return (new FVector3()).__assign(__p.bb_pos + 0, __p.bb); } }
  public FQuaternion Rotation { get { return (new FQuaternion()).__assign(__p.bb_pos + 24, __p.bb); } }
...
public struct FEulerTransform : IFlatbufferObject
{
  ...
  public FVector3 Position { get { return (new FVector3()).__assign(__p.bb_pos + 0, __p.bb); } }
  public FVector3 Rotation { get { return (new FVector3()).__assign(__p.bb_pos + 24, __p.bb); } }
  public FVector3 Direction { get { return (new FVector3()).__assign(__p.bb_pos + 48, __p.bb); } }
...
public struct FBody : IFlatbufferObject
{
  ...
  public FVector3 Velocity { get { return (new FVector3()).__assign(__p.bb_pos + 0, __p.bb); } }
  public FVector3 AngularVelocity { get { return (new FVector3()).__assign(__p.bb_pos + 24, __p.bb); } }
