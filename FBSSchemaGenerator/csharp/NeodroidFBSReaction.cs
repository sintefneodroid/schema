...
public struct FReaction : IFlatbufferObject
{
  ...
  public FReactionParameters? Parameters { get { int o = __p.__offset(6); return o != 0 ? (FReactionParameters?)(new FReactionParameters()).__assign(o + __p.bb_pos, __p.bb) : null; } }
